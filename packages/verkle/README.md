...
```shell
npm install @theqrl/zondjs-verkle
```
...
import { bytesToUtf8, createAddressFromString, getVerkleStem, utf8ToBytes } from '@theqrl/zondjs-util'
...
```ts
const { createVerkleTree } = require('@theqrl/zondjs-verkle')
```
