...
export class AccessLists {
  ...
  public static getDataGasEIP2930(
    ...
    return (
      ...
      slots * Number(accessListStorageKeyCost)
    );
  }
}
...
export class AuthorizationLists {
  ...
  public static verifyAuthorizationList(
  ...
  public static getDataGasEIP7702(
