import type { JSONBlock } from "@theqrl/zondjs-block";
...
const getProofValues = async (
  params: [address: string, _: [], blockTag: bigint | string],
) => {
...
const getBlockValues = async (params: [blockTag: string, _: boolean]) => {
  ...
  if (blockTag.slice(0, 2) !== "0x")
    return {
      number: "latest",
      stateRoot:
        "0x2ffb7ec5bbe8616c24a222737f0817f389d00ab9268f9574e0b7dfe251fbfa05",
    };
