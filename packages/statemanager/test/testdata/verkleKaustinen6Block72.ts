...
export const verkleKaustinen6Block72Data: Omit<BlockData, "transactions"> & {
  ...
  header: {
    number: "0x48",
    parentHash:
      "0xf3ecb69d884749d580a08fed05e05ee3967dffc66844715c0d6640c853962d3b",
    ...
    transactionsTrie:
      "0xe32d8329353256c4f60f7f029b8c26eb0638c9a32bfdfd37ad224b140e8c3b9f",
  },
  transactions: [
  ...
  executionWitness: {
    ...
    stateDiff: [
      {
        ...
        suffixDiffs: [
          ...
          },
          {
            suffix: 1,
            currentValue:
              "0x5fd4526134640504000000000000000000000000000000000000000000000000",
            newValue:
              "0x5f54de346f94ba04000000000000000000000000000000000000000000000000",
          },
          {
            suffix: 2,
            currentValue:
      ...
      },
      {
        ...
        suffixDiffs: [
          ...
          },
          {
            suffix: 1,
            currentValue:
              "0xebc17af0f95f7800000000000000000000000000000000000000000000000000",
            newValue:
              "0xfb9691f52c867800000000000000000000000000000000000000000000000000",
          },
          {
            suffix: 2,
            currentValue:
      ...
      },
      {
        ...
        suffixDiffs: [
          ...
          },
          {
            suffix: 1,
            currentValue:
              "0x50cbdee5305851973c2e3b030000000000000000000000000000000000000000",
            newValue:
              "0x70aa9d4b87d1e6953c2e3b030000000000000000000000000000000000000000",
          },
          {
            suffix: 2,
            currentValue:
      ...
      },
      {
        ...
        suffixDiffs: [
          ...
          },
          {
            ...
            newValue:
              "0x92b6fdb8628ab604000000000000000000000000000000000000000000000000",
          },
          {
            suffix: 2,
            currentValue:
    ...
    verkleProof: {
      ...
      ipaProof: {
        ...
        finalEvaluation:
          "0x10c46a855d6be4f7e48f287ce25c219c0f469cc00d83888d44efbd1342da1d2b",
      },
    },
  },
};
