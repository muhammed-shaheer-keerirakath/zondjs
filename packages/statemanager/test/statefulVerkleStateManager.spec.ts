...
describe("Verkle Tree API tests", () => {
  ...
  it("should return same stateRoot when putting and then deleting account", async () => {
    ...
    const address2 = createAddressFromString(
      "0x9e5ef720fa2cdfa5291eb7e711cfd2e62196f4b4",
    );
  ...
  it("should put and get code", async () => {
    ...
    const reallyBigByteCode = hexToBytes(
      (await import("./testdata/biggestContractEver.js"))
        .biggestContractEverData.bytecode as PrefixedHexString,
    );
