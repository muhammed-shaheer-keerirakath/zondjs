...
const genesisStateRoot =
  "0x78026f1e4f2ff57c340634f844f47cb241beef4c965be86a483c855793e4b07d";
const genesisBlockHash =
  "0x76a519ccb8a2b12d733ad7d88e2d5f4a11d6dc6ca320edccd3b8a3e9081ca1b3";

const originalValidate = (BlockHeader as any).prototype
    ...
    blockNumber === 1
      ...
      : Array.from({ length: 8 }, (_v, i) => {
          ...
          return {
            ...
            address: bytesToHex(
              setLengthRight(intToBytes(withdrawalIndex), 20),
            ),
...
async function runBlock(
  ...
  const { withdrawals, withdrawalsRoot } = await genBlockWithdrawals(
    Number(blockNumber),
  );
  ...
  const executePayload = blockToExecutionPayload(
    executeBlock,
    BigInt(0),
  ).executionPayload;
...
describe(`valid verkle network setup`, async () => {
  ...
  const testCases = [
    ...
    },
    {
      ...
      blockData: {
        transactions: kaustinen2Data.block12.execute
          .transactions as PrefixedHexString[],
        blockNumber: "0x02",
        stateRoot:
          "0xa86d54279c8faebed72e112310b29115d3600e8cc6ff2a2e4466a788b8776ad9",
        receiptTrie:
    ...
    },
    {
      ...
      blockData: {
        ...
        blockNumber: "0x03",
        stateRoot:
          "0xe4538f9d7531eb76e82edf7480e4578bc2be5f454ab02db4d9db6187dfa1f9ca",
        receiptTrie:
          "0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421",
        gasUsed: "0x0",
    ...
    },
    {
      ...
      blockData: {
        transactions: kaustinen2Data.block13.execute
          .transactions as PrefixedHexString[],
        blockNumber: "0x04",
        stateRoot:
          "0x57e675e1d6b2ab5d65601e81658de1468afad77752a271a48364dcefda856614",
        receiptTrie:
          "0x6a0be0e8208f625225e43681258eb9901ed753e2656f0cd6c0a3971fada5f190",
        gasUsed: "0x3c138",
  ...
  for (const testCase of testCases) {
    ...
    it(`run ${name}`, async () => {
      const { blockHash } = await runBlock(
        { common, rpc },
