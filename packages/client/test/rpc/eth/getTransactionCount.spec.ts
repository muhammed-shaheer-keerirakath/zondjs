...
describe(method, () => {
  it("call with valid arguments", async () => {
    ...
    assert.equal(
      res.result,
      `0x0`,
      "should return 0x0 for nonexistent account",
    );
  });
  ...
  it("call with pending block argument", async () => {
    ...
    const pk = hexToBytes(
      "0x266682876da8fd86410d001ec33c7c281515aeeb640d175693534062e2599238",
    );
    ...
    service.execution.vm.stateManager.setStateRoot = () =>
      Promise.resolve(undefined);
    service.execution.vm.shallowCopy = () =>
      Promise.resolve(service.execution.vm);
