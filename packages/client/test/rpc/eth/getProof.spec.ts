...
const expectedProof = {
  ...
  balance: "0x0",
  codeHash:
    "0x05698751a8fe928d7049ee0af6927f3ff6e398d7d11293ea4c6786d7cfc3dbd4",
  nonce: "0x1",
  storageHash:
    "0xb39609ba55cc225a26265fc5e80d51e07a4410c1725cf69dbf15a8b09ad1a0a0",
  accountProof: [
...
describe(method, async () => {
  ...
  */
    ...
    assert.deepEqual(
      res.result,
      expectedProof,
      "should return the correct proof",
    );
  });
});
