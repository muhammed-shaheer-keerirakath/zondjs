...
describe(method, async () => {
  it("call with valid arguments", async () => {
    ...
    const mockBlockHash =
      "0x0d52ca94a881e32dfe40db79623745b29883f4fe2ae23c14d01889bce4c069c0";
    const mockTxHash =
  ...
  it("call with no argument", async () => {
    ...
    assert.ok(
      res.error.message.includes("missing value for required argument 0"),
    );
  });
  ...
  it("call without tx hash", async () => {
    ...
    const mockBlockHash =
      "0x572856aae9a653012a7df7aeb56bfb7fe77f5bcb4b69fd971c04e989f6ccf9b1";
