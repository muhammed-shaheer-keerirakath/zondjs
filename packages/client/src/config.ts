...
export class Config {
  ...
  constructor(options: ConfigOptions = {}) {
    ...
    this.skeletonFillCanonicalBackStep =
      ...
      Config.SKELETON_FILL_CANONICAL_BACKSTEP;
    this.skeletonSubchainMergeMinimum =
      options.skeletonSubchainMergeMinimum ??
      Config.SKELETON_SUBCHAIN_MERGE_MINIMUM;
    ...
    this.ignoreStatelessInvalidExecs =
      options.ignoreStatelessInvalidExecs ?? false;
