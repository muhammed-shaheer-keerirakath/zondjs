...
const secret = hexToBytes(
  "0x4caf4671e713d083128973de159d02688dc86f51535a80178264631e193ed2ea",
);
...
describe("RLPx MAC tests", () => {
  ...
  it("#update", () => {
    ...
    assert.equal(
      bytesToHex(mac.digest()),
      "0x9c22ff5f21f0b81b113e63f7db6da94f",
    );
  });
  ...
  it("#updateHeader", () => {
    ...
    assert.equal(
      bytesToHex(mac.digest()),
      "0x52235ed491a4c9224d94788762ead6a6",
    );
  });
  ...
  it("#updateBody", () => {
    ...
    assert.equal(
      bytesToHex(mac.digest()),
      "0x134a755450b1ed9d3ff90ef5dcecdd7d",
    );
  });
  ...
  it("#updateHeader and #updateBody", () => {
    ...
    assert.equal(
      bytesToHex(mac.digest()),
      "0x5d98967578ec8edbb45e1d75992f394c",
    );
  });
});
