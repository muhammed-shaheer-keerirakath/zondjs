...
describe("EIP 1153: transient storage", () => {
  ...
  const runTest = async function (test: Test) {
    ...
    for (const { code, address } of test.contracts) {
      await vm.stateManager.putCode(
        address,
        hexToBytes(code as PrefixedHexString),
      );
    }
    ...
    await vm.stateManager.putAccount(
      fromAddress,
      new Account(BigInt(0), BigInt(0xfffffffff)),
    );
    const results = [];
  ...
  it("should tload and tstore", async () => {
    ...
    const address = new Address(
      hexToBytes("0x00000000000000000000000636F6E7472616374"),
    );
    ...
    const test = {
      ...
      steps: [
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
          ...
          expectedGasUsed: 3,
          expectedStack: [BigInt(2)],
        },
        {
          expectedOpcode: "TSTORE",
          expectedGasUsed: 100,
          expectedStack: [BigInt(2), BigInt(1)],
        },
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
          expectedOpcode: "TLOAD",
          expectedGasUsed: 100,
          expectedStack: [BigInt(1)],
        },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
        ...
        },
        {
          ...
          expectedGasUsed: 6,
          expectedStack: [BigInt(2), BigInt(0)],
        },
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
          expectedStack: [BigInt(32)],
        },
        {
          expectedOpcode: "RETURN",
          expectedGasUsed: NaN,
          expectedStack: [BigInt(32), BigInt(0)],
        },
      ],
    };
    ...
    const test = {
      ...
      steps: [
        ...
        },
        {
          ...
          expectedGasUsed: 3,
          expectedStack: [BigInt(0)],
        },
        {
          expectedOpcode: "JUMPI",
          expectedGasUsed: 10,
          expectedStack: [BigInt(0), BigInt(28)],
        },
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
          expectedOpcode: "PUSH4",
        ...
        },
        {
          expectedOpcode: "JUMPI",
          expectedGasUsed: 10,
          expectedStack: [BigInt(1), BigInt(18)],
        },
        ...
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
          expectedStack: [BigInt(255)],
        },
        {
          expectedOpcode: "TSTORE",
          expectedGasUsed: 100,
          expectedStack: [BigInt(255), BigInt(0)],
        },
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
          expectedOpcode: "DUP1",
        ...
        },
        {
          expectedOpcode: "RETURN",
          expectedGasUsed: -278,
          expectedStack: [BigInt(0), BigInt(0)],
        },
        // second tx
        {
          expectedOpcode: "CALLDATASIZE",
        ...
        },
        {
          expectedOpcode: "JUMPI",
          expectedGasUsed: 10,
          expectedStack: [BigInt(1), BigInt(28)],
        },
        { expectedOpcode: "JUMPDEST", expectedGasUsed: 1, expectedStack: [] },
        { expectedOpcode: "PUSH1", expectedGasUsed: 3, expectedStack: [] },
        {
  ...
  it("tload should not keep reverted changes", async () => {
    ...
    const logicAddress = new Address(
      hexToBytes("0xEA674fdDe714fd979de3EdF0F56AA9716B898ec8"),
    );
    ...
    const test = {
      ...
      steps: [
        { expectedOpcode: "PUSH4", expectedGasUsed: 3, expectedStack: [] },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
          expectedStack: [BigInt(1660795326)],
        },
        {
          expectedOpcode: "MSTORE",
          expectedGasUsed: 6,
        ...
        },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
          expectedStack: [BigInt(1), BigInt(32)],
        },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
        ...
        },
        {
          expectedOpcode: "DUP1",
          expectedGasUsed: 3,
          expectedStack: [BigInt(2949149906)],
        },
        {
          expectedOpcode: "PUSH4",
          expectedGasUsed: 3,
        ...
        },
        {
          expectedOpcode: "PUSH4",
          expectedGasUsed: 3,
          expectedStack: [BigInt(1), BigInt(0)],
        },
        {
          expectedOpcode: "PUSH1",
          expectedGasUsed: 3,
