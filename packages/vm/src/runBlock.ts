...
import { type EVM, type EVMInterface, VerkleAccessWitness } from '@theqrl/zondjs-evm'
import { MerklePatriciaTrie } from '@theqrl/zondjs-mpt'
import { RLP } from '@theqrl/zondjs-rlp'
import { StatelessVerkleStateManager, verifyVerkleStateProof } from '@theqrl/zondjs-statemanager'
...
import type { CLRequest, CLRequestType, PrefixedHexString } from '@theqrl/zondjs-util'

const debug = debugDefault('vm:block')

const parentBeaconBlockRootAddress = createAddressFromString(
  'Z000F3df6D732807Ef1319fB7B8bB8522d0Beac02',
)
