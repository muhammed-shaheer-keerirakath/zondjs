...
export class EVM implements EVMInterface {
  ...
  constructor(opts: EVMOpts) {
    ...
    const supportedEIPs = [
      ...
      5133, 5450, 5656, 6110, 6206, 6780, 6800, 7002, 7069, 7251, 7480, 7516,
      7620, 7685, 7691, 7692, 7698, 7702, 7709,
    ];
  ...
  protected async _executeCall(message: MessageWithTo): Promise<EVMResult> {
    ...
    if (this.common.isActivatedEIP(6800)) {
      ...
      let callAccessGas = message.accessWitness.readAccountBasicData(
        message.to,
      );
      if (sendsValue) {
        callAccessGas += message.accessWitness.writeAccountBasicData(
          message.to,
        );
      }
