...
import { Common, ConsensusAlgorithm, ConsensusType, Hardfork, Mainnet } from '@theqrl/zondjs-common'
import {
  BIGINT_0,
  BIGINT_1,
  BIGINT_8,
  ...
  constructor(opts: BlockchainOptions = {}) {
    this.DEBUG =
      typeof window === 'undefined'
        ? ((typeof process !== 'undefined' && process?.env?.DEBUG?.includes('ethjs')) ?? false)
        : false
